...
export function IntakeFormsList() {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Review and manage client intake form submissions</p>
        </div>
      ...
      {/* Filters */}
      <div className="bg-card rounded-xl p-4 border border-border flex flex-col md:flex-row gap-4">
