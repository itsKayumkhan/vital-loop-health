                                            ...
                                            >
                                                <Card className="h-full glass-card hover:border-secondary/40 transition-all duration-300 group flex flex-col">
                                                    ...
                                                    <CardFooter className="pt-0 flex gap-2">
                                                        ...
                                                        <Button
                                                            className="flex-1 bg-secondary hover:bg-secondary/90 disabled:bg-muted disabled:text-muted-foreground"
                                                            size="sm"
                                                            onClick={() => handleAddToCart(product)}
                                                            disabled={(product.node.totalInventory ?? 0) <= 0}
                                                        >
                                                            <ShoppingCart className="w-3.5 h-3.5 mr-2" />
                                                            {(product.node.totalInventory ?? 0) <= 0 ? 'Out of Stock' : 'Add to Cart'}
                                                        </Button>
                                                    </CardFooter>
                                                </Card>
                                            </motion.div>
